...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/mixer_paths_19696.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_19696.xml \
    ...
    $(LOCAL_PATH)/configs/audio/sound_trigger_mixer_paths_wcd9340_19696.xml:$(TARGET_COPY_OUT_VENDOR)/etc/sound_trigger_mixer_paths_wcd9340_19696.xml \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/wifi/WCNSS_qcom_cfg_19698.ini:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/WCNSS_qcom_cfg_19698.ini \
...
# Inherit vendor
$(call inherit-product, vendor/oppo/RMX2081L1/RMX2081L1-vendor.mk)